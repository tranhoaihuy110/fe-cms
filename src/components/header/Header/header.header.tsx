...
import { NotificationDropdown } from "../notification-dropdown/index";
import { UserDropdown } from "../user-dropdown/index";

import { IHeaderProps } from "./index";

export const Header: React.FC<IHeaderProps> = ({ onClick, onToggle }) => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-blue-900 border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
