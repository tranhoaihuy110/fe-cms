...
export const SfMartLeadsFormModal: React.FC<SfMartLeadsFormModalProps> = ({
  ...
  return (
    <FormModal<ISfMartLeadsGetApi>
      ...
      fields={fields}
      title={{
        add: "Add New Sf Mart Leads",
        edit: "Edit Sf Mart Leads",
        detail: "Sf Mart Leads Details",
      }}
      description={{
        add: "Create a new Sf Mart Leads with the details below.",
        edit: "Update the Sf Mart Leads details to keep it up-to-date.",
        detail: "View the details of the Sf Mart Leads below.",
      }}
      children={children}
    />
  );
