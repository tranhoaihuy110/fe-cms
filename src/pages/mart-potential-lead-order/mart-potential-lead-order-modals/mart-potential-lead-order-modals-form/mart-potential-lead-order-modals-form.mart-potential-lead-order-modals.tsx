...
> = ({ isOpen, onClose, onSubmit, mode, config, children = "" }) => {
  ...
  return (
    <FormModal<IMartPotentialLeadOrderGetApi>
      ...
      fields={fields}
      title={{
        add: "Add New Mart Potential Lead Order",
        edit: "Edit Mart Potential Lead Order",
        detail: "Mart Potential Lead Order Details",
      }}
      description={{
        add: "Create a new Mart Potential Lead Order with the details below.",
        edit: "Update the Mart Potential Lead Order details to keep it up-to-date.",
        detail: "View the details of the Mart Potential Lead Order below.",
      }}
      children={children}
    />
  );
