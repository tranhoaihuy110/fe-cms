...
export const MartPotentialLeadFormModal: React.FC<MartPotentialLeadFormModalProps> = ({
  ...
  return (
    <FormModal<IMartPotentialLeadGetApi>
      ...
      fields={fields}
      title={{
        add: "Add New Mart Potential Lead",
        edit: "Edit Mart Potential Lead",
        detail: "Mart Potential Lead Details",
      }}
      description={{
        add: "Create a new Mart Potential Lead with the details below.",
        edit: "Update the Mart Potential Lead details to keep it up-to-date.",
        detail: "View the details of the Mart Potential Lead below.",
      }}
      children={children}
    />
  );
