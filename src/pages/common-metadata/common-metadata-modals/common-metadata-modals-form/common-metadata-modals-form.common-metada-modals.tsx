...
export const CommonMetadataFormModal: React.FC<CommonMetadataFormModalProps> = ({
  ...
  return (
    <FormModal<ICommonMetadataGetApi>
      ...
      fields={fields}
      title={{
        add: "Add New Common MetaData",
        edit: "Edit Common MetaData",
        detail: "Common MetaData Details",
      }}
      description={{
        add: "Create a new Common MetaData with the details below.",
        edit: "Update the Common MetaData details to keep it up-to-date.",
        detail: "View the details of the Common MetaData below.",
      }}
      children={children}
    />
  );
