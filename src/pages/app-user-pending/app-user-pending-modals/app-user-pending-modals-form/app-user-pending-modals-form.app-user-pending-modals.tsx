...
> = ({ isOpen, onClose, onSubmit, mode, config, children = "" }) => {
  ...
  return (
    <FormModal<IAppUserPendingGetApi>
      ...
      fields={fields}
      title={{
        add: "Add New App User Pending",
        edit: "Edit App User Pending",
        detail: "App User Pending Details",
      }}
      description={{
        add: "Create a new App User Pending with the details below.",
        edit: "Update the App User Pending details to keep it up-to-date.",
        detail: "View the details of the App User Pending below.",
      }}
      children={children}
    />
  );
